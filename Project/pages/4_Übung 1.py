                ...
                if senden and frage_eigene:
                    ...
                    with st.spinner(text="Erstelle Text, bitte warten..."):
                        ...
                        if antwort_text_eigene is None and gemini_client:
                            try:
                                antwort = gemini_client.generate_content(prompt+"nur 2-3 Sätze. Gebe Details an wie Jahre, Zahlen oder Eigenschaften. Ändere die Zahlen oder Details ganz leicht. ")
